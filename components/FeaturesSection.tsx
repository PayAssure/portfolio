...
export default function FeaturesSection() {
  return (
    <section id="features" className="w-full rounded-3xl bg-blue-50 p-10 shadow-sm">
      <div className="w-full">
        <p className="text-sm uppercase tracking-[0.3em] text-blue-600 font-semibold">Enterprise Capabilities</p>
      ...
      <div className="mt-10 grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
        {features.map((feature) => (
          <div key={feature} className="rounded-3xl border border-blue-300 bg-white p-8 shadow-md hover:shadow-lg hover:border-blue-400 transition">
