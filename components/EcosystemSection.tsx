export default function EcosystemSection() {
  return (
    <section id="ecosystem" className="w-full py-5">
      ...
      <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 to-blue-50 px-4 py-8 sm:px-6 sm:py-12 lg:p-12 shadow-lg">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          {/* Manufacturers */}
          <div className="rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-6 sm:p-8">
          ...
          {/* Retailers */}
          <div className="rounded-xl border border-blue-200 bg-blue-50 px-4 py-6 sm:p-8">
            <div className="text-3xl mb-3">🏪</div>
          ...
          {/* Banks */}
          <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-6 sm:p-8">
            <div className="text-3xl mb-3">🏦</div>
          ...
          {/* Enterprises */}
          <div className="rounded-xl border border-slate-300 bg-slate-100 px-4 py-6 sm:p-8">
            <div className="text-3xl mb-3">🏢</div>
