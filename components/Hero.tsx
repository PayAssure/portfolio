export default function Hero() {
  return (
    <section className="w-full grid gap-16 lg:grid-cols-[1.2fr_0.8fr] items-center py-2 mt-7">
      <div className="w-full space-y-8">
        <div className="w-full space-y-4">
          ...
          <h1 className="text-4xl lg:text-6xl font-bold tracking-tight text-slate-950">PayAssure is a platform that automates settlements, reconciliation, and supply chain financing.</h1>
          <p className="text-lg leading-8 text-gray-600 max-w-lg">We connect manufacturers, retailers, financial institutions, and payment providers to ensure faster settlements, greater financial visibility, and more reliable supply chains.</p>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white/80 backdrop-blur px-4 py-6 sm:p-8 shadow-lg">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-xl bg-slate-900 px-4 py-4 sm:p-6 text-white">
            ...
            <div className="rounded-xl bg-slate-100/50 px-4 py-4 sm:p-6">
      ...
      <div className="w-full rounded-2xl bg-slate-900 px-4 py-6 sm:p-10 text-white shadow-2xl shadow-slate-900/25">
        <div className="text-xs uppercase tracking-[0.3em] text-emerald-400 font-semibold">Transaction Architecture</div>
        <div className="mt-8 space-y-4">
          <div className="rounded-lg bg-slate-800/50 px-3 py-3 sm:p-5 border border-slate-700">
